...
const n=require('../.sites-runtime/network-project.cjs'),lg=require('../.sites-runtime/network-link-geometry.cjs'),sg=require('../.sites-runtime/network-scene-geometry.cjs'),js=require('../.sites-runtime/scene-surfaces.cjs');
