...
import {armMouth,armTreatmentOrigins,medianEdges} from './geometry';
...
export function plantingPlan(d:Design,id:number){const a=d.arms[id],s={...medianTreeDefaults(),...a.medianTrees},mouth=armMouth(d,id),origins=armTreatmentOrigins(d,id),margin=s.crown/2+.2,requested=mouth+s.start,zones:Interval[]=[];
