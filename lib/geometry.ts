...
export type Component={id:string;roadId:string;type:'junction'|'pocket'|'opening';t:number;width:number;taper:number;storage:number;length:number;side:1|-1;arrow?:'right'|'straight'|'left'|'none'};
